...
({									\
	...
	obj = __sync_lock_test_and_set((FLAG), 1);			\
	asm volatile ("fence.i");					\
	obj;								\
})
...
({									\
 	__typeof__(*OBJ) obj;						\
	asm volatile ("fence.i");					\
	obj = __sync_fetch_and_add((OBJ), (VAL));			\
	asm volatile ("fence.i");					\
	obj;								\
})
...
({									\
 	__typeof__(*OBJ) obj;						\
	asm volatile ("fence.i");					\
	obj = __sync_fetch_and_sub((OBJ), (VAL));			\
	asm volatile ("fence.i");					\
	obj;								\
})
...
({									\
 	__typeof__(*OBJ) obj;						\
	asm volatile ("fence.i");					\
	obj = __sync_fetch_and_or((OBJ), (VAL));			\
	asm volatile ("fence.i");					\
	obj;								\
})
...
({									\
 	__typeof__(*OBJ) obj;						\
	asm volatile ("fence.i");					\
	obj = __sync_fetch_and_xor((OBJ), (VAL));			\
	asm volatile ("fence.i");					\
	obj;								\
})
...
({									\
 	__typeof__(*OBJ) obj;						\
	asm volatile ("fence.i");					\
	obj = __sync_fetch_and_and((OBJ), (VAL));			\
	asm volatile ("fence.i");					\
	obj;								\
})
