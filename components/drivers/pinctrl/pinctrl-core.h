#ifndef __RT_PINCTRL_CORE_H__
#define __RT_PINCTRL_CORE_H__
...
#define for_each_maps(_maps_node_, _i_, _map_) \
        rt_list_for_each_entry(_maps_node_, &pinctrl_maps, node) \
                for (_i_ = 0, _map_ = &_maps_node_->maps[_i_]; \
                        _i_ < _maps_node_->num_maps; \
                        _i_++, _map_ = &_maps_node_->maps[_i_])

#endif /* __RT_PINCTRL_CORE_H__ */
