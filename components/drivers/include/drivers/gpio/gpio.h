#ifndef __RT_USING_GPIO_H__
#define __RT_USING_GPIO_H__
...
struct gpio_chip {
	...
	int (*of_xlate)(struct gpio_chip *gc,
			const struct fdt_phandle_args *gpiospec, unsigned int *flags);
	/*
