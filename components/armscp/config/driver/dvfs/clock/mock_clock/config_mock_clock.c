...
static const struct mod_mock_clock_rate little_rate_table[] = {
    { .rate = 1536000 }, { .rate = 2116800 }, { .rate = 2304000 },
    { .rate = 4233600 }, { .rate = 4608000 }, { .rate = 8467200 },
    { .rate = 9216000 },
};

static const struct mod_mock_clock_rate gpu_rate_table[] = {
    { .rate = 1536000 }, { .rate = 2116800 }, { .rate = 2304000 },
    { .rate = 4233600 }, { .rate = 4608000 }, { .rate = 8467200 },
    { .rate = 9216000 },
};
    ...
    [MOD_MOCK_CLOCK_ELEMENT_IDX_LITTLECLK] =
        {
            ...
            .data = &(const struct mod_mock_clock_element_cfg){
                    .rate_table = little_rate_table,
                    .rate_count = FWK_ARRAY_SIZE(little_rate_table),
    ...
    [MOD_MOCK_CLOCK_ELEMENT_IDX_GPUCLK] =
        {
            .name = "MOCK_GPUCLK",
            .data = &(const struct mod_mock_clock_element_cfg){
                    .rate_table = gpu_rate_table,
                    .rate_count = FWK_ARRAY_SIZE(gpu_rate_table),
                    .default_rate = 1536000,
                },
        },
