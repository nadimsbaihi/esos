...
#define SPACEMIT_CCU_DIV2_FC_MUX_GATE(_struct, _name, _parents, _base_type,	\
				      _reg_ctrl, _reg_sel, _mshift, _mwidth,	\
				      _fc, _muxshift, _muxwidth, _gate_mask,	\
...
#define SPACEMIT_CCU_MUX_FC(_struct, _name, _parents, _base_type,	\
			    _reg_ctrl, _fc, _muxshift, _muxwidth,	\
			    _flags)				\
	struct ccu_mix _struct = {				\
		.mux = CCU_MUX_INIT(_muxshift, _muxwidth, NULL, 0),	\
		.common = { 					\
